...
Phase 3 (specialized agent reviews) is not available in this installation. Proceed directly to the success output.
...
File created:
- docs/solutions/runtime-errors/stack-overflow-material-variant-merge.md

This documentation will be searchable for future reference when similar
issues occur in the Graphics or Serialization modules.
...
- `/externalize-learning` - Lightweight knowledge externalization (investigation notes)
- `/externalize-feature-learning` - Feature-specific knowledge externalization
